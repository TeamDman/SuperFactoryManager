...
public abstract class TileEntityClusterElement extends TileEntity implements ITickable {
    ...
    public ItemStack getItemStackFromBlock() { // todo: fix cluster registry
        return registryElement != null ? registryElement.getItemStack(getBlockMetadata()) :
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound) {
        ...
        return super.writeToNBT(compound);// todo: java.lang.RuntimeException: class
                                          // vswe.superfactory.tiles.TileEntityBreaker is missing a mapping! This is a
                                          // bug
    }
