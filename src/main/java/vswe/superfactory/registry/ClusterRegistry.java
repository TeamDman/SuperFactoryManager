...
public class ClusterRegistry {
    ...
    public static class ClusterRegistryAdvancedSensitive extends ClusterRegistryElement {
        ...
        public ClusterRegistryAdvancedSensitive(Class<? extends TileEntityClusterElement> clazz, BlockContainer block,
                                                ItemStack itemStack) {
    ...
    public static class ClusterRegistryElement {
        ...
        private ClusterRegistryElement(Class<? extends TileEntityClusterElement> clazz, BlockContainer block,
                                       ItemStack itemStack) {
            this.clazz = clazz;
            this.block = block;
    ...
    public static class ClusterRegistryMetaSensitive extends ClusterRegistryElement {
        ...
        public ClusterRegistryMetaSensitive(Class<? extends TileEntityClusterElement> clazz, BlockContainer block,
                                            ItemStack itemStack) {
            super(clazz, block, itemStack);
        }
