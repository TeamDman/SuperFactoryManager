...
public class OutputItemCounter {
    ...
    public OutputItemCounter(List<ItemBufferElement> itemBuffer, List<SlotInventoryHolder> inventories,
                             SlotInventoryHolder inventoryHolder, ItemSetting setting, boolean useWhiteList) {
    ...
    public String toString() {
        return "stack=" + (setting == null ? "unknown" : setting.getItem().toString()) + ", bufferStack=" +
                currentBufferStackSize + ", invStack=" + currentInventoryStackSize +
                (useWhiteList ? ", whitelisted" : "");
    }
}
