...
public class ComponentMenuCamouflageShape extends ComponentMenuCamouflageAdvanced {
    ...
    public ComponentMenuCamouflageShape(FlowComponent parent) {
        ...
        checkBoxes.addCheckBox(
                new CheckBox(Localization.CAMOUFLAGE_COLLISION_USE, CHECK_BOX_X, CHECK_BOX_Y + CHECK_BOX_SPACING_Y) {
        ...
        checkBoxes.addCheckBox(new CheckBox(Localization.CAMOUFLAGE_COLLISION_FULL, CHECK_BOX_X + CHECK_BOX_SPACING_X,
                CHECK_BOX_Y + CHECK_BOX_SPACING_Y) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            textBoxes.addTextBox(new TextBoxRange(i, TEXT_BOX_X + TEXT_BOX_SPACING_X * x,
                    TEXT_BOX_Y + TEXT_BOX_SPACING_Y * y, x == 0 ? 0 : 32));
        }
    ...
    public void refreshData(ContainerManager container, ComponentMenu newData) {
        ...
        if (inUse != newDataShape.inUse || useCollision != newDataShape.useCollision ||
