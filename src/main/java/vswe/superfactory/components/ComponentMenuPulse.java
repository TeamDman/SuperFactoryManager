...
public class ComponentMenuPulse extends ComponentMenu {
    ...
    public ComponentMenuPulse(FlowComponent parent) {
        ...
        for (int i = 0; i < PULSE_OPTIONS.values().length; i++) {
            ...
            radioButtons.add(new RadioButton(RADIO_BUTTON_X + x * RADIO_BUTTON_SPACING_X,
                    RADIO_BUTTON_Y + y * RADIO_BUTTON_SPACING_Y, PULSE_OPTIONS.values()[i].getName()));
        }
    ...
    public void draw(GuiManager gui, int mX, int mY) {
        ...
        if (usePulse) {
            ...
            gui.drawCenteredString(Localization.SECONDS.toString(), secondsTextBox.getX(), secondsTextBox.getY() - 7,
                    0.7F, secondsTextBox.getWidth(), 0x404040);
            gui.drawCenteredString(Localization.TICKS.toString(), ticksTextBox.getX(), ticksTextBox.getY() - 7, 0.7F,
                    ticksTextBox.getWidth(), 0x404040);
        }
    }
