...
public class FluidBufferElement {
    ...
    public FluidBufferElement(FlowComponent owner, Setting setting, SlotInventoryHolder inventoryHolder,
                              boolean useWhiteList, StackTankHolder target) {
    ...
    public int getBufferSize(Setting outputSetting) {
        ...
        for (StackTankHolder holder : getHolders()) {
            ...
            if (fluidStack != null &&
                    fluidStack.getFluid().getName().equals(((FluidSetting) outputSetting).getFluidName())) {
    ...
    public FluidBufferElement getSplitElement(int elementAmount, int id, boolean fair) {
        FluidBufferElement element = new FluidBufferElement(this.component, this.setting, this.inventoryHolder,
                this.useWhiteList);
