...
public class CapabilityUtils {
    ...
    public static IFluidHandler getFluidHandlerOr(IBlockAccess world, BlockPos pos, EnumFacing face,
                                                  IFluidHandler _default) {
    ...
    public static IItemHandler getItemHandlerOr(IBlockAccess world, BlockPos pos, EnumFacing face,
                                                IItemHandler _default) {
        return getItemHandlerOr(world.getTileEntity(pos), face, _default);
    }
