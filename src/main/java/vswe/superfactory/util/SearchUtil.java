...
public class SearchUtil {
    ...
    private static final Multimap<ItemStack, String> cache = Multimaps
        ...
        new Thread(() -> {
            ...
            try {
                ...
                stacks.stream()
                        ...
                        .sorted(Comparator
                                .<ItemStack>comparingInt(s -> s.getItem().getRegistryName() != null &&
                                        s.getItem().getRegistryName().getNamespace().equals("minecraft") ? 0 : 1)
                ...
                System.out.println("[SFM] Indexed " + stacks.size() + " items in " +
                        (System.currentTimeMillis() - time_no_see) + "ms.");
    ...
    public static String getTooltip(ItemStack stack, @Nullable EntityPlayer playerIn) {
        ...
        stack.getItem().addInformation(stack, playerIn == null ? null : playerIn.world, asd,
        ...
        for (EntityEquipmentSlot entityequipmentslot : EntityEquipmentSlot.values()) {
            ...
            if (!multimap.isEmpty()) {
                ...
                for (Map.Entry<String, AttributeModifier> entry : multimap.entries()) {
                    ...
                    if (flag) {
                        list.append(I18n.translateToLocalFormatted(
                                "attribute.modifier.equals." + attributemodifier.getOperation(),
                                DECIMALFORMAT.format(d1), I18n.translateToLocal("attribute.name." + entry.getKey())));
                    } else if (d0 > 0.0D) {
                        list.append(I18n.translateToLocalFormatted(
        ...
        if (stack.isItemDamaged()) {
            list.append(I18n.translateToLocalFormatted("item.durability", stack.getMaxDamage() - stack.getItemDamage(),
                    stack.getMaxDamage()));
        }
