...
public class ModelLoader implements ICustomModelLoader {
    ...
    public boolean accepts(ResourceLocation modelLocation) {
        return modelLocation.getNamespace().equals(SuperFactoryManager.MODID.toLowerCase()) &&
                modelLocation.getPath().startsWith("models/block/builtin/");
    }

    @Override
    public IModel loadModel(ResourceLocation modelLocation) {
        String model = modelLocation.getPath().substring("models/block/builtin/".length());
