...
public class BlockCableBreaker extends BlockContainer {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        if (entityBreaker != null && entityBreaker.getPlaceDirection() != null) {
            return state.withProperty(FACING, entityBreaker.getPlaceDirection()).withProperty(FRONT,
                    getSide(getMetaFromState(state)));
        }
        return state.withProperty(FACING, getSide(getMetaFromState(state))).withProperty(FRONT,
                getSide(getMetaFromState(state)));
    }
