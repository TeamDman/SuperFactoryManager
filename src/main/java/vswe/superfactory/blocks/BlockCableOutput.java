...
public class BlockCableOutput extends BlockContainer {
    ...
    public static final IUnlistedProperty<Integer> STRONG_SIDES = new Properties.PropertyAdapter<Integer>(
            PropertyInteger.create("strong_sides", 0, 63)); // 000000 -> 111111
    public static final IUnlistedProperty<Integer> WEAK_SIDES = new Properties.PropertyAdapter<Integer>(
            PropertyInteger.create("strong_sides", 0, 63)); // 000000 -> 111111
    ...
    public IBlockState getExtendedState(IBlockState state, IBlockAccess world, BlockPos pos) {
        ...
        if (state instanceof IExtendedBlockState && tileEntity != null) {
            ...
            return ((IExtendedBlockState) state).withProperty(STRONG_SIDES, strongVals).withProperty(WEAK_SIDES,
                    weakVals);
        }
        return state;
    }
