...
public abstract class GuiAntiNEI extends GuiScreen {
     ...
     */
    public static final ResourceLocation inventoryBackground = new ResourceLocation(
     ...
     * @param pointX     X coordinate of the point, on screen. this.guiLeft is subtracted from it to get the test
     *                   location
     *                   within the rectangle
     * @param pointY     Y coordinate of the point, on screen. this.guiTop is subtracted from it to get the test
     *                   location
     *                   within the rectangle
     */
