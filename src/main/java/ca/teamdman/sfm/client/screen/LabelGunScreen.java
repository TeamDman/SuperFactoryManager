...
//    private final ArrayList<Button> labelButtons = new ArrayList<>();
    ...
    public LabelGunScreen(ItemStack labelGunStack, EnumHand hand) {
        super();
        // title LocalizationKeys.LABEL_GUN_GUI_TITLE.getComponent();
...
//        this.labelField = addRenderableWidget(new GuiTextField(0,
//                this.font,
//                this.width / 2 - 150,
//                50,
//                300,
...
//        ));
//        this.labelField.setGuiResponder(new GuiPageButtonList.GuiResponder() {
//
//            @Override
