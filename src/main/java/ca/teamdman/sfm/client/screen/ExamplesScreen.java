...
//
// public class ExamplesScreen extends GuiScreen {
...
// List<String> disallowedResourceTypesForTransfer =
// java.util.Arrays.asList(SFMConfig.server.disallowedResourceTypesForTransfer);
