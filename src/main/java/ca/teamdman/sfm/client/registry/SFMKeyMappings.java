...
public class SFMKeyMappings {
    ...
    public static final KeyBinding LABEL_GUN_CLEAR_MODIFIER_KEY = new KeyBinding(LocalizationKeys.LABEL_GUN_CLEAR_MODIFIER_KEY.key().get(), Keyboard.KEY_LSHIFT, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding LABEL_GUN_SCROLL_MODIFIER_KEY = new KeyBinding(LocalizationKeys.LABEL_GUN_SCROLL_MODIFIER_KEY.key().get(), Keyboard.KEY_LSHIFT, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding LABEL_GUN_NEXT_LABEL_KEY = new KeyBinding(LocalizationKeys.LABEL_GUN_NEXT_LABEL_KEY.key().get(), Keyboard.KEY_NONE, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding LABEL_GUN_PREVIOUS_LABEL_KEY = new KeyBinding(LocalizationKeys.LABEL_GUN_PREVIOUS_LABEL_KEY.key().get(), Keyboard.KEY_NONE, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding LABEL_GUN_PULL_MODIFIER_KEY = new KeyBinding(LocalizationKeys.LABEL_GUN_PULL_MODIFIER_KEY.key().get(), Keyboard.KEY_LSHIFT, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding LABEL_GUN_TARGET_MANAGER_MODIFIER_KEY = new KeyBinding(LocalizationKeys.LABEL_GUN_TARGET_MANAGER_MODIFIER_KEY.key().get(), Keyboard.KEY_RMENU, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding MANAGER_SCREEN_OPEN_TEXT_EDITOR_KEY = new KeyBinding(LocalizationKeys.MANAGER_SCREEN_OPEN_TEXT_EDITOR_KEY.key().get(), Keyboard.KEY_E, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
    public static final KeyBinding TITLE_SCREEN_OPEN_TEXT_EDITOR_KEY = new KeyBinding(LocalizationKeys.TITLE_SCREEN_OPEN_TEXT_EDITOR_KEY.key().get(), Keyboard.KEY_E, LocalizationKeys.SFM_KEY_CATEGORY.key().get());
