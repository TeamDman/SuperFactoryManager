...
public class SFMEventListenerMethod<T extends Event> {
    ...
    public void register() {
        ...
        // Determine bus
        SFMEventBus.EventBusType busType = getEventBusType();
        EventBus eventBus = SFMEventBus.getEventBus(busType);
...
//        );
    ...
    private @NotNull SFMEventBus.EventBusType getEventBusType() {

//        if (IModBusEvent.class.isAssignableFrom(eventClass)) {
//            return SFMEventBus.EventBusType.MOD;
//        } else {
            return SFMEventBus.EventBusType.GAME;
//        }
    }
