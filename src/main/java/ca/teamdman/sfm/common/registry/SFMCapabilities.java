...
public class SFMCapabilities {
    ...
    public static void register() {
        CapabilityManager.INSTANCE.register(IRedstoneSignalStorage.class, new Capability.IStorage<>() {
            ...
            @Override
            public NBTBase writeNBT(Capability<IRedstoneSignalStorage> capability, IRedstoneSignalStorage instance,
                                    EnumFacing side) {
                return new NBTTagInt(instance.getStoredAmount());
            }

            @Override
            public void readNBT(Capability<IRedstoneSignalStorage> capability, IRedstoneSignalStorage instance,
