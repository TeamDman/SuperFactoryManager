...
public class LibraryRecompileOnCableRemovalGameTest extends SFMGameTestDefinition {
    ...
    public void run(SFMGameTestHelper helper) {
        ...
        helper.setBlock(cablePos, SFMBlocks.CABLE_BLOCK.get());
        ...
        ItemStack providerDisk = new ItemStack(SFMItems.DISK_ITEM.get());
        ...
        ItemStack consumerDisk = new ItemStack(SFMItems.DISK_ITEM.get());
