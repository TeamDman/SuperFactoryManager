...
public class SFMLTestHelpers {
    ...
    public record CompileErrors(
        ...
        public static final CompileErrors NONE = new CompileErrors(Collections.emptyList(), Collections.emptyList(), Collections.emptyList());

        public CompileErrors(Throwable... visitProblems) {
            this(Collections.emptyList(), Collections.emptyList(), Arrays.asList(visitProblems));
        }
