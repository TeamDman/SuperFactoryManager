...
public class CodegenTests {
    ...
    public void codegen() {
        ...
        var program = new Program(
                new ASTBuilder(),
                "hello world",
                Arrays.asList(new TimerTrigger(
                        new Interval(20, Interval.IntervalAlignment.LOCAL, 0),
                        new Block(Arrays.asList(new IfStatement(
                                new BoolHas(
                                        SetOperator.OVERALL,
                                        aLabel,
                                        ComparisonOperator.GREATER_OR_EQUAL,
                                        10L,
                                        new ResourceIdSet(Arrays.asList(ResourceIdentifier.fromString("sfm:item:.*:.*"))),
                                        With.ALWAYS_TRUE,
                                        ResourceIdSet.EMPTY
                                ),
                                new Block(Arrays.asList(
                                        ...
                                        new InputStatement(
                                                aLabel,
                                                new ResourceLimits(
                                                        Arrays.asList(ResourceLimit.TAKE_ALL_LEAVE_NONE),
                                                        ResourceIdSet.EMPTY
                                                ),
