...
public final class SFMSourceComparisonPanel implements SFMScreenPanel {
    ...
    @ca.teamdman.sfm.common.util.MCVersionDependentBehaviour
    private void renderOperationList(GuiGraphics graphics, Minecraft minecraft, SFMClientTheme theme,
    ...
    @ca.teamdman.sfm.common.util.MCVersionDependentBehaviour
    private void renderDetail(GuiGraphics graphics, Minecraft minecraft, SFMClientTheme theme,
    ...
    @ca.teamdman.sfm.common.util.MCVersionDependentBehaviour
    private static void renderCode(GuiGraphics graphics, Minecraft minecraft, SFMClientTheme theme,
    ...
    @ca.teamdman.sfm.common.util.MCVersionDependentBehaviour
    private static void draw(GuiGraphics graphics, Minecraft minecraft, String text, int x, int y,
