...
/** Asynchronous UI-facing seam for one references-at-position lookup. */
public interface SFMReferenceLookupService {
    record Lookup(
    ...
    Submission queryReferences(SFMContextContribution contribution);
}
