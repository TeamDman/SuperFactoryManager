...
import com.bbscn.MultiLineEditBox;
import com.bbscn.Rect2i;
import com.bbscn.Whence;
...
class LogsScreenMultiLineEditBox extends MultiLineEditBox {
    ...
    public List<ITextComponent> styledTextContentLines = Collections.emptyList();
    ...
    public boolean mouseClicked(
         int pMouseX, int pMouseY, int pButton
    ) {
        ...
        try {
            ...
            if (pButton == 0 && this.visible && this.withinContentAreaPoint(pMouseX, pMouseY)) {
                ...
                boolean shiftDown = GuiScreenExtend.hasShiftDown();
    ...
    public int getInnerHeight() {
        ...
        return this.font.FONT_HEIGHT * (styledTextContentLines.size() + 2);
    }
    ...
    protected void renderContents(
        ...
        textRenderWidget.render(mx, my, partialTicks);
    }
