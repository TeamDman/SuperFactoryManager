...
//public class SFMTextEditorConfigScreen extends GuiScreen {
//    private final SFMConfig.Client config;
//    private final ISFMTextEditScreen parent;
//    private final Runnable closeCallback;
//    private GuiButton lineNumbersOnButton;
//    private GuiButton lineNumbersOffButton;
//    private GuiButton intellisenseOffButton;
//    private GuiButton intellisenseBasicButton;
//    private GuiButton intellisenseAdvancedButton;
//    private GuiButton preferredEditorV1Button;
//    private GuiButton preferredEditorV2Button;
...
//                        .setOnPress(button -> {
//                            //noinspection OptionalGetWithoutIsPresent
//                            config.preferredEditor.set(SFMTextEditors.V2.getId().get().location().toStrinpreferredEditorg());
//                            updateButtonStates();
//                        })
//                        .build();
//        if (editorSelectorFeatureFlag) {
