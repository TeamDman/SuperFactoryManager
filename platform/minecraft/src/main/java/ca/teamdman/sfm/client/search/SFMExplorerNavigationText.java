...
public final class SFMExplorerNavigationText {
    ...
    @SFMLocalizationDatagen public static final LocalizationEntry SET_ROOT = new LocalizationEntry("gui.sfm.explorer.navigation.set_root", "Use this entry as the only root");
    @SFMLocalizationDatagen public static final LocalizationEntry ADD_ROOT = new LocalizationEntry("gui.sfm.explorer.navigation.add_root", "Add entry as root");
