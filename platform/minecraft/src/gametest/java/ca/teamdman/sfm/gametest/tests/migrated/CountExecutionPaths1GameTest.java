...
@SFMGameTest
public class CountExecutionPaths1GameTest extends SFMGameTestDefinition {
    ...
    public void run(SFMGameTestHelper helper) {
        ...
        assertTrue(simulation.getSeenPaths().size() == 1, "expected single execution path", helper.getTick());
