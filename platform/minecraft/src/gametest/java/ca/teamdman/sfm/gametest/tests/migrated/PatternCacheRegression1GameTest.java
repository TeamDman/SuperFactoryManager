...
/**
 * Migrated from SFMCorrectnessGameTests.pattern_cache_regression_1
 */
@SuppressWarnings({
...
@SFMGameTest
public class PatternCacheRegression1GameTest extends SFMGameTestDefinition {
    ...
    public void run(SFMGameTestHelper helper) {
        ...
        helper.succeedIfManagerDidThingWithoutLagging(manager, () -> {
            assertTrue(leftChest.getStackInSlot(0).getCount() == 64, "should not depart", helper.getTick());
            assertTrue(rightChest.getStackInSlot(0).isEmpty(), "should not arrive", helper.getTick());
