...
/**
 * Migrated from SFMCorrectnessGameTests.each_dest_quantity_retain
 */
@SuppressWarnings({
...
@SFMGameTest
public class EachDestQuantityRetainGameTest extends SFMGameTestDefinition {
    ...
    public void run(SFMGameTestHelper helper) {
        ...
        helper.succeedIfManagerDidThingWithoutLagging(manager, () -> {
            ...
            helper.assertCount(leftChest, Items.IRON_INGOT, 0, "Iron moved", helper.getTick());
            helper.assertCount(leftChest, Items.GOLD_INGOT, 1, "Gold did not move", helper.getTick());
            helper.assertCount(rightChest, Items.IRON_INGOT, 2, "Iron arrive", helper.getTick());
            helper.assertCount(rightChest, Items.GOLD_INGOT, 1, "Gold did not arrive", helper.getTick());
